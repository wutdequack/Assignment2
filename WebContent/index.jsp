...
<form action="searchgameprocess.jsp" class="navbar-form" role="search" method="post">
                                <div class="input-group">
                                <h4>Search Game: </h4>
...
<form action="searchpreowned.jsp" class="navbar-form" role="search" method="post">
    ...
    <form action="searchgamegenre.jsp" name="form1" method="post">
