			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
                        ...
                        <div class="box">
                            ...
                            <div class="heading">
                                <h3 class="text-uppercase">Delete Genre</h3>
                            </div>

                            <form action="updateGenreBack.jsp">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                             		...
                             		<br>
                                            ...
                                            <input type="text" name="updategenrenew" class="form-control" id="genre_new">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-template-main"><i class="fa fa-save"></i> Update Genre</button>
                                </div>
                            </form>
						</div>
                        </div>
