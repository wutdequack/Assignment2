...
<body>
	<%
		...
		PreparedStatement pstmt = conn.prepareStatement("Select * from games ga, games_genre gg, genre ge where ga.id_Game = gg.id_Game AND gg.id_Genre = ge.id_Genre AND ga.id_Game=8");
				...
				<div class="row portfolio-project">
					...
					<div class="col-sm-4">
						<div class="project-more">							
							...
							<p>	
								...
								PreparedStatement pstmt1 = conn1.prepareStatement("Select * from games ga, games_genre gg, genre ge where ga.id_Game = gg.id_Game AND gg.id_Genre = ge.id_Genre AND ga.id_Game=8");
					...
					<div class="col-sm-12">
						...
						<%
								...
								PreparedStatement pstmt2 = conn2.prepareStatement("Select * from games ga, games_genre gg, genre ge where ga.id_Game = gg.id_Game AND gg.id_Genre = ge.id_Genre AND ga.id_Game=8");
...
PreparedStatement pstmt3 = conn3.prepareStatement("Select * from games ga, games_comment gc, comment co where ga.id_Game = gc.id_Game AND gc.id_Comment = co.id_Comment AND ga.id_Game=8");
...
%>
				...
				<div class="box">
					<form action="commentsBack.jsp">
                                ...
                                <input type="hidden" value="8" name="gameid">
