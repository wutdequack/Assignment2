			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
                        ...
                        <div class="box">
                            ...
                            <div class="heading">
                                <h3 class="text-uppercase">Add Game</h3>
                            </div>

                            <form action="addGameBack.jsp">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_old">Game Title</label>
                                            <input type="text" name="title" class="form-control" id="password_old">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company" class="form-control" id="password_1">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" class="form-control" id="password_2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">Genre</label>
                                            <br>
                            		...
                            		Connection conn = DriverManager.getConnection(connURL);
                             		...
                             		while(rs.next()){
                             			...
                             			%>
                             			<input type="checkbox" name="genreInput" value="<%=id%>"><%=name%><br>
                             		<%}%>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">Description</label>
                                            <input type="text" name="desc" class="form-control" id="password_1">
                                        </div>
                                    </div>
                                    </div>
                                   <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">Price in $</label>
                                            <input type="text" name="price" class="form-control" id="password_1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">Pre-owned</label>
                                            <input type="checkbox" name="preowned" value=1 class="form-control" id="password_1">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">System Specs</label>
                                            <input type="text" name="ss" class="form-control" id="password_1">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_1">Image</label>
                                            <input type="text" name="img" class="form-control" id="password_1">
                                        </div>
                                    </div>
                                    </div>
