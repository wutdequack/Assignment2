...
<%@page import="java.sql.*, java.util.ArrayList, DB.*, member.*" %>
...
<%
	String login =(String)session.getAttribute("memlo");
			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
                        <div class="box clearfix">
							...
							<form action="UpdateUserController" method="POST" onsubmit="return validateForm(this);"> 
							<% ArrayList<MemberDetails> MemberDetails = new ArrayList<MemberDetails>();
                                    for(MemberDetails md: MemberDetails){
                                    %>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="firstname">Name</label>
                                            <input type="text" class="form-control" id="firstname" name="name" value="<%=md.getMemname()%>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lastname">Email/Username</label>
                                            <input type="text" class="form-control" id="lastname" name="user" value="<%=md.getMememail()%>">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="company" name="pwd" value="<%=md.getMempwd()%>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="street">Phone Number</label>
                                            <input type="text" class="form-control" id="street" name="no" value="<%=md.getNo()%>">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="addr" value="<%=md.getMailingadd()%>">
                                        </div>
                                    </div>
