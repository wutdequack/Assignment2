			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-9 clearfix" id="customer-account">
                        ...
                        <div class="box">
                            ...
                            <form action="deleteGenreBack.jsp">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password_old">Delete Genre</label>
                                            <select name="gid">
                                            <%
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-template-main"><i class="fa fa-save"></i> Delete Genre</button>
                                </div>
                            </form>
						</div>
                        </div>
